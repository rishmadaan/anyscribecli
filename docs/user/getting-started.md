...
4. **Enter your API key** — stored locally at `~/.anyscribecli/.env`. Never sent anywhere except your provider.
...
8. **Keep audio files** — whether to save the transcription audio to `~/.anyscribecli/downloads/audio/`.
