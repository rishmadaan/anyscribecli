...
from anyscribe.config.paths import RECOVERY_DIR, TMP_DIR
from anyscribe.config.settings import Settings
from anyscribe.downloaders.registry import get_downloader
from anyscribe.providers import get_provider
from anyscribe.vault.writer import write_transcript, format_duration
from anyscribe.vault.index import update_indexes
...
def process(
    ...
    from anyscribe.core.migrate import (
    ...
    if flattened:
        from anyscribe.vault.index import rebuild_master_index
    ...
    if not force:
        from anyscribe.core.dedup import find_existing_transcript, read_frontmatter
