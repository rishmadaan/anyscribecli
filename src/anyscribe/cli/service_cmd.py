...
def install_service(
    ...
    from anyscribe.core.service import install_service as do_install, plist_path
...
def uninstall_service(
    ...
    _require_macos(output_json)
    from anyscribe.core.service import plist_path, uninstall_service as do_uninstall
